...
def index(request):
    ...
    return render(request, "shop/index_A.html", {'products':products, 'cartItems':cartItems})
...
def product_view(request, myid):
    ...
    return render(request, "shop/product_view.html", {'product':product, 'cartItems':cartItems, 'feature':feature, 'reviews':reviews})
